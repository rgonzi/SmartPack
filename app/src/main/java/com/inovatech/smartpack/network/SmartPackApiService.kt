...
interface SmartPackApiService {
     ...
     * @param deliveryConfirmationDTO: El número de telèfon del destinatari del servei per confirmar la entrega
     */
    ...
    /**
     * Petició per assignar/desassignar un transportista a un servei
     *
     */
    @PUT("/servei/{id}/assignar-transportista/{transportistaId}")
    suspend fun assignDeliverymanToService(@Path("id") serviceId: Long, @Path("transportistaId") deliverymanId: Long?): Response<ServiceDTO>
